...
router.get('/getAllBlock',bbs.getAllBlock)
router.get('/getHotPosts',bbs.getHotPosts)
router.get('/getLikesPostByUserID',bbs.getLikesPostByUserID)
router.post('/addVisit',bbs.addVisit)
router.get('/getVisitByUserID',bbs.getVisitByUserID)
router.get('/clearVisit',bbs.clearVisit)
router.post('/checkPassPost',bbs.checkPassPost)
router.get('/getPostDeatilData',bbs.getPostDeatilData)
router.post('/getPostDeatilDataByBlock',bbs.getPostDeatilDataByBlock)
router.post('/deletePostByPostID',bbs.deletePostByPostID)
router.post('/canclePostTop',bbs.canclePostTop)
router.post('/setPostTop',bbs.setPostTop)
router.post('/cancelPostWonderful',bbs.cancelPostWonderful)
router.post('/setPostWonderful',bbs.setPostWonderful)
