...
var _bbs = _interopRequireDefault(__webpack_require__(/*! ./pages/bbs/bbs.vue */ 324));
// @ts-ignore
...
/* harmony import */ var _bbs_vue_vue_type_template_id_126f986e___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./bbs.vue?vue&type=template&id=126f986e& */ 325);
/* harmony import */ var _bbs_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./bbs.vue?vue&type=script&lang=js& */ 327);
...
/* harmony import */ var _bbs_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./bbs.vue?vue&type=style&index=0&lang=scss& */ 329);
...
try {
  components = {
    uModal: function () {
      return Promise.all(/*! import() | uni_modules/uview-ui/components/u-modal/u-modal */[__webpack_require__.e("common/vendor"), __webpack_require__.e("uni_modules/uview-ui/components/u-modal/u-modal")]).then(__webpack_require__.bind(null, /*! @/uni_modules/uview-ui/components/u-modal/u-modal.vue */ 952))
    },
    uSearch: function () {
    ...
    uSwiper: function () {
      return Promise.all(/*! import() | uni_modules/uview-ui/components/u-swiper/u-swiper */[__webpack_require__.e("common/vendor"), __webpack_require__.e("uni_modules/uview-ui/components/u-swiper/u-swiper")]).then(__webpack_require__.bind(null, /*! @/uni_modules/uview-ui/components/u-swiper/u-swiper.vue */ 968))
    },
    uNoticeBar: function () {
      return Promise.all(/*! import() | uni_modules/uview-ui/components/u-notice-bar/u-notice-bar */[__webpack_require__.e("common/vendor"), __webpack_require__.e("uni_modules/uview-ui/components/u-notice-bar/u-notice-bar")]).then(__webpack_require__.bind(null, /*! @/uni_modules/uview-ui/components/u-notice-bar/u-notice-bar.vue */ 976))
    },
...
var _default = {
  ...
  methods: {
    ...
    getSwiperData: function getSwiperData() {
      var _this = this;
      uni.$u.http.get("bbs/getWonderfulPost").then(function (res) {
        var data = res.data.data;
        var swpierData = data.map(function (item) {
          return {
            id: item.id,
            image: item.image[0],
            title: item.title
    ...
    toPageDetail: function toPageDetail(index) {
      var postID = this.list3[index].id;
      uni.navigateTo({
    ...
    getPageData: function getPageData() {
      var _this2 = this;
      uni.$u.http.get('/bbs').then(function (res) {
        var data = res.data.data;
