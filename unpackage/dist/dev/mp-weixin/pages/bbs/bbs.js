...
try {
  components = {
    ...
    uSwiper: function () {
      return Promise.all(/*! import() | uni_modules/uview-ui/components/u-swiper/u-swiper */[__webpack_require__.e("common/vendor"), __webpack_require__.e("uni_modules/uview-ui/components/u-swiper/u-swiper")]).then(__webpack_require__.bind(null, /*! @/uni_modules/uview-ui/components/u-swiper/u-swiper.vue */ 509))
    },
    uNoticeBar: function () {
      return Promise.all(/*! import() | uni_modules/uview-ui/components/u-notice-bar/u-notice-bar */[__webpack_require__.e("common/vendor"), __webpack_require__.e("uni_modules/uview-ui/components/u-notice-bar/u-notice-bar")]).then(__webpack_require__.bind(null, /*! @/uni_modules/uview-ui/components/u-notice-bar/u-notice-bar.vue */ 517))
    },
...
var _default = {
  ...
  methods: {
    //获取热门板块
    getHotBlock: function getHotBlock() {
      var _this = this;
      uni.$u.http.get("/bbs/getHotBlock").then(function (res) {
        var data = res.data;
        _this.blockData = data.map(function (item) {
          return {
            id: item.id,
            name: item.name
          };
        ...
        uni.$u.http.get("/bbs/getBlockPostNum").then(function (res) {
          var num = res.data;
          // 遍历板块分类
          _this.blockData.forEach(function (block) {
            // 在板块中有帖子的数据中查找
